        ...
        c.extend(b.prototype, {
          ...
          show: function(a) {
            ...
            if (
              ...
              if (
                ...
                e || c(window).on("resize", c.proxy(this.reset, this)),
                this.modal)
              ) {
                var h = {
                  position: "fixed",
            ...
            return (
              d.addClass(this.className + "-show").show(),
              g.show(),
              this.reset().focus(),
          ...
          focus: function() {
            ...
            if (
              ...
              !this._autofocus && g ? (this._autofocus = !0) : (g = a),
                this.__focus(g);
            }
            return (
              d.css("zIndex", f),
      ...
      var g = 0,
        ...
        l = function(a, c, d) {
          ...
          return i
            ? i.focus()
            : (k || (a.fixed = !1),
              a.quickClose && ((a.modal = !0), (a.backdropOpacity = 0)),
        ...
        (l.create = function(a) {
          ...
          return (
            ...
            this.addEventListener("show", function() {
              f
                .css({ opacity: 0, background: a.backdropBackground })
                .animate({ opacity: a.backdropOpacity }, 150);
            }),
