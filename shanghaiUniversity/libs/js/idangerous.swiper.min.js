...
var Swiper = function(a, b) {
  ...
  function f() {
    ...
    if (
      (C.browser.ie10 || C.browser.ie11
        ? (d(e, C.touchEvents.touchStart, p),
          d(document, C.touchEvents.touchMove, q),
          d(document, C.touchEvents.touchEnd, r))
        : (C.support.touch &&
            (d(e, "touchstart", p), d(e, "touchmove", q), d(e, "touchend", r)),
          b.simulateTouch &&
            (d(e, "mousedown", p),
  ...
  function i(a) {
    ...
    if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey)) {
      if (37 === b || 39 === b || 38 === b || 40 === b) {
        for (
          var c = !1,
            d = C.h.getOffset(C.container),
            e = C.h.windowScroll().left,
            f = C.h.windowScroll().top,
            g = C.h.windowWidth(),
            h = C.h.windowHeight(),
            i = [
              [d.left, d.top],
    ...
    if (C.isTouched && !b.onlyExternal && (!Z || "mousemove" !== a.type)) {
      ...
      if (
        ("undefined" == typeof H &&
          M &&
          (H = !!(
            H || Math.abs(d - C.touches.startY) > Math.abs(c - C.touches.startX)
          )),
        "undefined" != typeof H ||
          M ||
          (H = !!(
      ...
      if (M) {
        if (
          (!b.swipeToNext && c < C.touches.startX) ||
          (!b.swipeToPrev && c > C.touches.startX)
        )
          return;
      } else if (
        (!b.swipeToNext && d < C.touches.startY) ||
        (!b.swipeToPrev && d > C.touches.startY)
      )
        return;
      ...
      if (
        ...
        if (
          (C.isMoved ||
            (C.callPlugins("onTouchMoveStart"),
            b.loop &&
              (C.fixLoop(), (C.positions.start = C.getWrapperTranslate())),
            b.onTouchMoveStart && C.fireCallback(b.onTouchMoveStart, C)),
          (C.isMoved = !0),
          a.preventDefault ? a.preventDefault() : (a.returnValue = !1),
          (C.touches.current = M ? c : d),
          (C.positions.current =
            (C.touches.current - C.touches.start) * b.touchRatio +
            C.positions.start),
          C.positions.current > 0 &&
            b.onResistanceBefore &&
            C.fireCallback(b.onResistanceBefore, C, C.positions.current),
          C.positions.current < -e() &&
            b.onResistanceAfter &&
            C.fireCallback(
              b.onResistanceAfter,
              C,
              Math.abs(C.positions.current + e())
            ),
          ...
          if (
            (C.positions.current > 0 &&
              ((f = 1 - C.positions.current / I / 2),
              (C.positions.current =
                0.5 > f ? I / 2 : C.positions.current * f)),
            C.positions.current < -e())
          ) {
            var g =
              (C.touches.current - C.touches.start) * b.touchRatio +
        ...
        if (b.moveStartThreshold)
          if (
            Math.abs(C.touches.current - C.touches.start) >
        ...
        return (
          (b.freeMode || b.watchActiveIndex) &&
            C.updateActiveSlide(C.positions.current),
          b.grabCursor &&
            ((C.container.style.cursor = "move"),
          ...
          (C.velocity =
            (C.touches.current - X) / (new Date().getTime() - Y) / 2),
    ...
    if ((H && C.swipeReset(), !b.onlyExternal && C.isTouched)) {
      ...
      if (((C.isMoved = !1), b.freeMode)) {
        if (b.freeModeFluid) {
          ...
          -g > k &&
            (b.momentumBounce && C.support.transitions
              ? (-m > k + g && (k = -g - m), (h = -g), (l = !0), ($ = !0))
              : (k = -g)),
            k > 0 &&
              (b.momentumBounce && C.support.transitions
                ? (k > m && (k = m), (h = 0), (l = !0), ($ = !0))
                : (k = 0)),
            0 !== C.velocity &&
              (i = Math.abs((k - C.positions.current) / C.velocity)),
      ...
      (G = 0 > c ? "toNext" : "toPrev"),
        "toNext" === G &&
          300 >= f &&
          (30 > d || !b.shortSwipes ? C.swipeReset() : C.swipeNext(!0)),
        "toPrev" === G &&
          300 >= f &&
          (30 > d || !b.shortSwipes ? C.swipeReset() : C.swipePrev(!0));
      var n = 0;
      if ("auto" === b.slidesPerView) {
        for (
          var o, p = Math.abs(C.getWrapperTranslate()), q = 0, r = 0;
          r < C.slides.length;
          r++
        )
          if (
            ((o = M
              ? C.slides[r].getWidth(!0, b.roundLengths)
              : C.slides[r].getHeight(!0, b.roundLengths)),
            (q += o),
            q > p)
          ) {
            n = o;
      ...
      "toNext" === G &&
        f > 300 &&
        (d >= n * b.longSwipesRatio ? C.swipeNext(!0) : C.swipeReset()),
        "toPrev" === G &&
          f > 300 &&
          (d >= n * b.longSwipesRatio ? C.swipePrev(!0) : C.swipeReset()),
        b.onTouchEnd && C.fireCallback(b.onTouchEnd, C, a),
  ...
  function s(a) {
    ...
    return (
      !c &&
        a.className.indexOf(b.wrapperClass) > -1 &&
        a.className.indexOf(b.noSwipingClass) > -1 &&
        (c = !0),
      c
    );
  }
  ...
  function u(a, c, d) {
    function e() {
      ...
      (h += i * l / (1e3 / 60)),
        (k = "toNext" === j ? h > a : a > h),
        k
          ? (C.setWrapperTranslate(Math.ceil(h)),
            (C._DOMAnimating = !0),
          ...
          : (b.onSlideChangeEnd &&
              ("to" === c
                ? d.runCallbacks === !0 &&
                  C.fireCallback(b.onSlideChangeEnd, C, j)
                : C.fireCallback(b.onSlideChangeEnd, C, j)),
    ...
    C.updateActiveSlide(a),
      ...
      ("next" === c || "prev" === c || ("to" === c && d.runCallbacks === !0)) &&
        v(c);
  }
  function v(a) {
  ...
  function y(a) {
    for (
      var c, d = a.target || a.srcElement, e = C.paginationButtons, f = 0;
      f < e.length;
      f++
    )
      d === e[f] && (c = f);
  ...
  function A() {
    C.calcSlides(),
      ...
      b.loop || b.initialSlide > 0
        ? C.swipeTo(b.initialSlide, 0, !1)
        : C.updateActiveSlide(0),
  ...
  if (
    ...
    B.__defineGetter__ &&
      B.__defineGetter__("outerHTML", function() {
  ...
  if (
    ...
    (C.touches = {
      ...
      (C.positions = { start: 0, abs: 0, diff: 0, current: 0 }),
      (C.times = { start: 0, end: 0 }),
    ...
    for (var O = C.container.childNodes.length - 1; O >= 0; O--)
      if (C.container.childNodes[O].className)
        for (
          var P = C.container.childNodes[O].className.split(/\s+/), Q = 0;
          Q < P.length;
          Q++
        )
    ...
    (C.wrapper = D),
      (C._extendSwiperSlide = function(a) {
        return (
          (a.append = function() {
            return (
              b.loop
                ? a.insertAfter(C.slides.length - C.loopedSlides)
                : (C.wrapper.appendChild(a), C.reInit()),
              a
            );
          }),
          (a.prepend = function() {
            return (
              b.loop
                ? (C.wrapper.insertBefore(a, C.slides[C.loopedSlides]),
                  C.removeLoopedSlides(),
                  C.calcSlides(),
                  C.createLoop())
                : C.wrapper.insertBefore(a, C.wrapper.firstChild),
              C.reInit(),
              a
            );
          }),
          (a.insertAfter = function(c) {
            ...
            return (
              b.loop
                ? ((d = C.slides[c + 1 + C.loopedSlides]),
                  d ? C.wrapper.insertBefore(a, d) : C.wrapper.appendChild(a),
                  C.removeLoopedSlides(),
                  C.calcSlides(),
                  C.createLoop())
                : ((d = C.slides[c + 1]), C.wrapper.insertBefore(a, d)),
              C.reInit(),
              a
            );
          }),
      ...
      (C.calcSlides = function(a) {
        ...
        for (var d = 0; d < C.wrapper.childNodes.length; d++)
          if (C.wrapper.childNodes[d].className)
            for (
              var e = C.wrapper.childNodes[d].className,
                f = e.split(/\s+/),
                i = 0;
              i < f.length;
              i++
      ...
      (C.createSlide = function(a, c, d) {
        ...
        return (
          (e.innerHTML = a || ""), (e.className = c), C._extendSwiperSlide(e)
        );
      }),
      (C.appendSlide = function(a, b, c) {
        return a
          ? a.nodeType
            ? C._extendSwiperSlide(a).append()
            : C.createSlide(a, b, c).append()
          : void 0;
      }),
      (C.prependSlide = function(a, b, c) {
        return a
          ? a.nodeType
            ? C._extendSwiperSlide(a).prepend()
            : C.createSlide(a, b, c).prepend()
          : void 0;
      }),
      (C.insertSlideAfter = function(a, b, c, d) {
        return "undefined" == typeof a
          ? !1
          : b.nodeType
            ? C._extendSwiperSlide(b).insertAfter(a)
            : C.createSlide(b, c, d).insertAfter(a);
      }),
      ...
      (C.removeLastSlide = function() {
        return C.slides.length > 0
          ? (b.loop
              ? (C.slides[C.slides.length - 1 - C.loopedSlides].remove(),
                C.removeLoopedSlides(),
                C.calcSlides(),
                C.createLoop())
              : C.slides[C.slides.length - 1].remove(),
            !0)
          : !1;
      }),
    ...
    (C.callPlugins = function(a, b) {
      ...
      (!C.browser.ie10 && !C.browser.ie11) ||
        b.onlyExternal ||
        C.wrapper.classList.add(
          "swiper-wp8-" + (M ? "horizontal" : "vertical")
        ),
        ...
        if (d !== C.width || e !== C.height || a) {
          ...
          if ((a && C.calcSlides(c), "auto" === b.slidesPerView)) {
            ...
            b.slidesOffset > 0 &&
              ...
              b.offsetPxBefore > 0 &&
                (M
                  ? (C.wrapperLeft = b.offsetPxBefore)
                  : (C.wrapperTop = b.offsetPxBefore)),
              b.offsetPxAfter > 0 &&
                (M
                  ? (C.wrapperRight = b.offsetPxAfter)
                  : (C.wrapperBottom = b.offsetPxAfter)),
              b.centeredSlides &&
                (M
                  ? ((C.wrapperLeft =
                      (I - this.slides[0].getWidth(!0, b.roundLengths)) / 2),
                    (C.wrapperRight =
                      (I -
                        C.slides[C.slides.length - 1].getWidth(
                          !0,
                          b.roundLengths
                        )) /
                      2))
                  : ((C.wrapperTop =
                      (I - C.slides[0].getHeight(!0, b.roundLengths)) / 2),
                    (C.wrapperBottom =
                      (I -
                        C.slides[C.slides.length - 1].getHeight(
                          !0,
                          b.roundLengths
                        )) /
                      2))),
              M
                ? (C.wrapperLeft >= 0 &&
                    (m.style.paddingLeft = C.wrapperLeft + "px"),
                  C.wrapperRight >= 0 &&
                    (m.style.paddingRight = C.wrapperRight + "px"))
                : (C.wrapperTop >= 0 &&
                    (m.style.paddingTop = C.wrapperTop + "px"),
                  C.wrapperBottom >= 0 &&
                    (m.style.paddingBottom = C.wrapperBottom + "px")),
              (k = 0);
            var p = 0;
            for (
              C.snapGrid = [], C.slidesGrid = [], h = 0, l = 0;
              l < C.slides.length;
              l++
            ) {
              ...
              if (b.centeredSlides) {
                var r =
                    l === C.slides.length - 1
                      ? 0
                      : C.slides[l + 1].getWidth(!0, b.roundLengths),
                  s =
                    l === C.slides.length - 1
                      ? 0
                      : C.slides[l + 1].getHeight(!0, b.roundLengths),
                  t = M ? r : s;
                if (q > I) {
                  if (b.slidesPerViewFit)
                    ...
                    for (
                      var u = 0;
                      u <= Math.floor(q / (I + C.wrapperLeft));
                      u++
                    )
                      C.snapGrid.push(
                        0 === u ? k + C.wrapperLeft : k + C.wrapperLeft + I * u
                      );
            ...
            b.calculateHeight && (C.height = h),
              M
                ? ((F = n + C.wrapperRight + C.wrapperLeft),
                  (m.style.width = n + "px"),
                  (m.style.height = C.height + "px"))
                : ((F = o + C.wrapperTop + C.wrapperBottom),
            ...
            for (
              f = M ? C.width / b.slidesPerView : C.width,
                b.roundLengths && (f = Math.ceil(f)),
                i = M ? C.slides.length * f : C.width,
                E = M ? f : g,
                b.offsetSlidesBefore > 0 &&
                  (M
                    ? (C.wrapperLeft = E * b.offsetSlidesBefore)
                    : (C.wrapperTop = E * b.offsetSlidesBefore)),
                b.offsetSlidesAfter > 0 &&
                  (M
                    ? (C.wrapperRight = E * b.offsetSlidesAfter)
                    : (C.wrapperBottom = E * b.offsetSlidesAfter)),
                b.offsetPxBefore > 0 &&
                  (M
                    ? (C.wrapperLeft = b.offsetPxBefore)
                    : (C.wrapperTop = b.offsetPxBefore)),
                ...
                M
                  ...
                  : (C.wrapperTop > 0 &&
                    ...
                    C.wrapperBottom > 0 &&
                      (m.style.paddingBottom = C.wrapperBottom + "px")),
                F = M
                  ? i + C.wrapperRight + C.wrapperLeft
                  : j + C.wrapperTop + C.wrapperBottom,
                parseFloat(i) > 0 &&
              ...
              C.snapGrid.push(k),
                ...
                parseFloat(f) > 0 &&
                  (!b.cssWidthAndHeight || "height" === b.cssWidthAndHeight) &&
                  (C.slides[l].style.width = f + "px"),
                parseFloat(g) > 0 &&
                  (!b.cssWidthAndHeight || "width" === b.cssWidthAndHeight) &&
                  (C.slides[l].style.height = g + "px");
          }
          C.initialized
            ? (C.callPlugins("onInit"), b.onInit && C.fireCallback(b.onInit, C))
            : (C.callPlugins("onFirstInit"),
      ...
      (C.resizeFix = function(a) {
        C.callPlugins("beforeResizeFix"),
          ...
          b.freeMode
            ? C.getWrapperTranslate() < -e() &&
              (C.setWrapperTransition(0), C.setWrapperTranslate(-e()))
            : (C.swipeTo(b.loop ? C.activeLoopIndex : C.activeIndex, 0, !1),
              b.autoplay &&
                (C.support.transitions && "undefined" != typeof _
                  ? "undefined" != typeof _ &&
                    (clearTimeout(_), (_ = void 0), C.startAutoplay())
                  : "undefined" != typeof ab &&
                    (clearInterval(ab), (ab = void 0), C.startAutoplay()))),
      ...
      (C.destroy = function() {
        ...
        C.browser.ie10 || C.browser.ie11
          ? (a(c, C.touchEvents.touchStart, p),
            a(document, C.touchEvents.touchMove, q),
            a(document, C.touchEvents.touchEnd, r))
          : (C.support.touch &&
              (a(c, "touchstart", p),
              a(c, "touchmove", q),
              a(c, "touchend", r)),
    ...
    (C.swipeNext = function(a) {
      ...
      (C.swipeReset = function() {
        ...
        if ("auto" === b.slidesPerView) {
          ...
          -c >= C.snapGrid[C.snapGrid.length - 1] &&
            (a = -C.snapGrid[C.snapGrid.length - 1]),
            c <= -e() && (a = -e());
        } else (a = 0 > c ? Math.round(c / d) * d : 0), c <= -e() && (a = -e());
        return (
          b.scrollContainer && (a = 0 > c ? c : 0),
          a < -e() && (a = -e()),
      ...
      (C.swipeTo = function(a, c, d) {
        (a = parseInt(a, 10)),
          C.callPlugins("onSwipeTo", { index: a, speed: c }),
          b.loop && (a += C.loopedSlides);
        var f = C.getWrapperTranslate();
        if (!(a > C.slides.length - 1 || 0 > a)) {
          var g;
          return (
            (g = "auto" === b.slidesPerView ? -C.slidesGrid[a] : -a * E),
            g < -e() && (g = -e()),
            g === f
              ? !1
              : ((d = d === !1 ? !1 : !0),
                u(g, "to", { index: a, speed: c, runCallbacks: d }),
                !0)
          );
        }
      }),
      ...
      (C.updateActiveSlide = function(a) {
        if (C.initialized && 0 !== C.slides.length) {
          ...
          if ("auto" === b.slidesPerView) {
            if (
              ((C.activeIndex = C.slidesGrid.indexOf(-a)), C.activeIndex < 0)
            ) {
              for (
                c = 0;
                c < C.slidesGrid.length - 1 &&
                !(-a > C.slidesGrid[c] && -a < C.slidesGrid[c + 1]);
                c++
              );
            ...
            C.activeIndex = Math[b.visibilityFullFit ? "ceil" : "round"](
              -a / E
            );
          if (
            (C.activeIndex === C.slides.length &&
              (C.activeIndex = C.slides.length - 1),
            ...
            if ((C.calcVisibleSlides(a), C.support.classList)) {
              ...
              for (c = 0; c < C.slides.length; c++)
                (C.slides[c].className = C.slides[c].className
                  .replace(g, "")
                  .replace(h, "")),
                  C.visibleSlides.indexOf(C.slides[c]) >= 0 &&
                    (C.slides[c].className += " " + b.slideVisibleClass);
              C.slides[C.activeIndex].className += " " + b.slideActiveClass;
            }
            if (b.loop) {
              var i = C.loopedSlides;
              (C.activeLoopIndex = C.activeIndex - i),
                C.activeLoopIndex >= C.slides.length - 2 * i &&
                  (C.activeLoopIndex =
                    C.slides.length - 2 * i - C.activeLoopIndex),
                C.activeLoopIndex < 0 &&
                  (C.activeLoopIndex =
                    C.slides.length - 2 * i + C.activeLoopIndex),
      ...
      (C.createPagination = function(a) {
        if (
          (b.paginationClickable && C.paginationButtons && w(),
          (C.paginationContainer = b.pagination.nodeType
            ? b.pagination
            : c(b.pagination)[0]),
          b.createPagination)
        ) {
            ...
            if (0 !== e.length) {
              ...
              if (b.paginationAsRange) {
                ...
                for (h = 0; h < C.visibleSlides.length; h++) {
                  ...
                  b.loop &&
                    0 > j &&
                    (j = C.slides.length - 2 * C.loopedSlides + j),
                    b.loop &&
                      j >= C.slides.length - 2 * C.loopedSlides &&
                      ((j = C.slides.length - 2 * C.loopedSlides - j),
                      (j = Math.abs(j))),
                    i.push(j);
                }
                for (h = 0; h < i.length; h++)
                  e[i[h]] &&
                    (e[i[h]].className += " " + b.paginationVisibleClass);
                b.loop
                  ? void 0 !== e[C.activeLoopIndex] &&
                    (e[C.activeLoopIndex].className +=
                      " " + b.paginationActiveClass)
                  : (e[C.activeIndex].className +=
                      " " + b.paginationActiveClass);
              } else
                b.loop
                  ? e[C.activeLoopIndex] &&
          ...
          (d += e),
            (e =
              "auto" === b.slidesPerView
                ? M
                  ? C.h.getWidth(C.slides[g], !0, b.roundLengths)
                  : C.h.getHeight(C.slides[g], !0, b.roundLengths)
                : E),
            (f = d + e);
          var h = !1;
          b.visibilityFullFit
    ...
    (C.startAutoplay = function() {
      ...
      (C.removeLoopedSlides = function() {
        if (C.loopCreated)
          for (var a = 0; a < C.slides.length; a++)
            C.slides[a].getData("looped") === !0 &&
              C.wrapper.removeChild(C.slides[a]);
      }),
      (C.createLoop = function() {
        if (0 !== C.slides.length) {
          (C.loopedSlides =
            "auto" === b.slidesPerView
              ? b.loopedSlides || 1
              : b.slidesPerView + b.loopAdditionalSlides),
            C.loopedSlides > C.slides.length &&
              (C.loopedSlides = C.slides.length);
          var a,
            c = "",
            d = "",
          ...
          for (
            D.innerHTML = k, C.loopCreated = !0, C.calcSlides(), a = 0;
            a < C.slides.length;
            a++
          )
            (a < C.loopedSlides || a >= C.slides.length - C.loopedSlides) &&
      ...
      (C.fixLoop = function() {
        ...
        C.activeIndex < C.loopedSlides
          ? ((a = C.slides.length - 3 * C.loopedSlides + C.activeIndex),
            C.swipeTo(a, 0, !1))
          : (("auto" === b.slidesPerView &&
              C.activeIndex >= 2 * C.loopedSlides) ||
              C.activeIndex > C.slides.length - 2 * b.slidesPerView) &&
            ((a = -C.slides.length + C.activeIndex + C.loopedSlides),
            C.swipeTo(a, 0, !1));
      }),
      ...
      (C.reloadSlides = function() {
        ...
        if (!(0 > c || c > a.length - 1)) {
          ...
          var d = Math.max(0, c - b.slidesPerView * b.loader.surroundGroups),
            e = Math.min(
              c + b.slidesPerView * (1 + b.loader.surroundGroups) - 1,
              a.length - 1
            );
          if (c > 0) {
            var f = -E * (c - d);
          ...
          if ("reload" === b.loader.logic) {
            ...
            for (g = 0; g < C.slides.length; g++) {
              ...
              d > k || k > e
                ? C.wrapper.removeChild(C.slides[g])
...
(Swiper.prototype = {
  ...
  wrapperTransitionEnd: function(a, b) {
    ...
    function c(h) {
      if (
        h.target === f &&
        (a(e), e.params.queueEndCallbacks && (e._queueEndCallbacks = !1), !b)
      )
        ...
        ? ((d = window.getComputedStyle(f, null)),
          ...
          "x" === a &&
            (c = window.WebKitCSSMatrix
              ? e.m41
              : parseFloat(16 === b.length ? b[12] : b[4])),
          "y" === a &&
            (c = window.WebKitCSSMatrix
              ? e.m42
  ...
  setWrapperTranslate: function(a, b, c) {
    ...
    3 === arguments.length
      ? ((f.x = a), (f.y = b), (f.z = c))
      : ("undefined" == typeof b &&
          (b = "horizontal" === this.params.mode ? "x" : "y"),
        (f[b] = a)),
      this.support.transforms && this.params.useCSS3Transforms
      ...
      return (
        (isNaN(e) || d.indexOf("%") > 0 || 0 > e) &&
          (e =
            a.offsetWidth -
            parseFloat(
              window.getComputedStyle(a, null).getPropertyValue("padding-left")
            ) -
            parseFloat(
              window.getComputedStyle(a, null).getPropertyValue("padding-right")
            )),
        b &&
          (e +=
            parseFloat(
      ...
      return (
        (isNaN(e) || d.indexOf("%") > 0 || 0 > e) &&
          (e =
            a.offsetHeight -
            parseFloat(
              window.getComputedStyle(a, null).getPropertyValue("padding-top")
            ) -
            parseFloat(
              window
